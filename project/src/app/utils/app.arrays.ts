...
export const pages=['רמזור בישובים', 'התחסנות האוכלוסיה', 'תחלואה חוזרת ומחלימים', 'תחקורים נוספים', 'בדיקות', 'נפטרים', 'חולים קשה ומאושפזים', 'השפעת התחסנות על התחלואה', 'תחלואה מחול', 'תחלואה ואשפוזי ילדים', 'מדדי תחלואה כללית', 'מדדים מרכזיים', 'מבט על' ] ;

export const titles4= ['מאומתים יומי - התחסנות', 'חולים קשה - התחסנות'];

export const titles3=['אחוז תפוסת מיטות באישפוזים', 'תפוסת מיטות בביה&quot;ח']
